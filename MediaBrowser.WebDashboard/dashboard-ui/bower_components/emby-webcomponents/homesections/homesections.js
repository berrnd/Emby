define(["cardBuilder", "appSettings", "dom", "apphost", "layoutManager", "imageLoader", "globalize", "itemShortcuts", "itemHelper", "appRouter", "emby-button", "paper-icon-button-light", "emby-itemscontainer", "emby-scroller", "emby-linkbutton", "css!./homesections"], function(cardBuilder, appSettings, dom, appHost, layoutManager, imageLoader, globalize, itemShortcuts, itemHelper, appRouter) {
    ...
    function renderLatestSection(elem, apiClient, user, parent) {
        ...
        return apiClient.getJSON(apiClient.getUrl("Users/" + user.Id + "/Items/Latest", options)).then(function(items) {
            ...
            if (items.length) {
				...
				html += '<div class="sectionTitleContainer padded-left">', layoutManager.tv ? html += '<h2 class="sectionTitle sectionTitle-cards">' + "Neues in " + parent.Name + "</h2>" : (html += '<a is="emby-linkbutton" href="' + appRouter.getRouteUrl(parent, {
					section: "latest"
    ...
    function loadLatestChannelMedia(elem, apiClient, userId) {
        ...
        return apiClient.getJSON(apiClient.getUrl("Channels/Items/Latest", options)).then(function(result) {
            var html = "";
            result.Items.length && (html += '<h2 class="sectionTitle sectionTitle-cards padded-left">' + globalize.translate("sharedcomponents#HeaderLatestChannelMedia") + "</h2>", html += enableScrollX() ? '<div is="emby-scroller" data-mousewheel="false" data-centerfocus="true"><div class="scrollerframe padded-top-focusscale padded-bottom-focusscale"><div is="emby-itemscontainer" class="scrollSlider focuscontainer-x padded-left padded-right">' : '<div is="emby-itemscontainer" class="itemsContainer padded-left padded-right vertical-wrap focuscontainer-x">', html += cardBuilder.getCardsHtml({
                items: result.Items,
                shape: "auto",
                showTitle: !0,
                centerText: !0,
    ...
    function loadOnNow(elem, apiClient, user) {
        ...
        return apiClient.getLiveTvRecommendedPrograms({
            ...
            result.Items.length && (html += '<div class="verticalSection">', html += '<div class="sectionTitleContainer padded-left">', html += '<h2 class="sectionTitle">' + globalize.translate("sharedcomponents#LiveTV") + "</h2>", html += "</div>", enableScrollX() ? (html += '<div is="emby-scroller" class="padded-top-focusscale padded-bottom-focusscale" data-mousewheel="false" data-centerfocus="true" data-scrollbuttons="false">', html += '<div class="scrollSlider padded-left padded-right padded-top padded-bottom focuscontainer-x">') : html += '<div class="padded-left padded-right padded-top focuscontainer-x">', html += '<a style="margin:0;padding:.9em 1em;" is="emby-linkbutton" href="' + appRouter.getRouteUrl("livetv", {
                ...
                serverId: apiClient.serverId(),
                section: "guide"
            }) + '" class="raised"><i class="md-icon">&#xE1B2;</i><span>' + globalize.translate("sharedcomponents#Guide") + "</span></a>", html += '<a style="margin:0 0 0 1em;padding:.9em 1em;" is="emby-linkbutton" href="' + appRouter.getRouteUrl("recordedtv", {
                serverId: apiClient.serverId()
            }) + '" class="raised"><i class="md-icon">&#xE333;</i><span>' + globalize.translate("sharedcomponents#Recordings") + "</span></a>", html += '<a style="margin:0 0 0 1em;padding:.9em 1em;" is="emby-linkbutton" href="' + appRouter.getRouteUrl("livetv", {
                serverId: apiClient.serverId(),
                section: "dvrschedule"
        ...
        apiClient.getJSON(apiClient.getUrl("Channels/Items/Latest", options)).then(function(result) {
            ...
            if (result.Items.length) {
                ...
                html += '<h2 class="sectionTitle sectionTitle-cards padded-left">' + text + "</h2>", layoutManager.tv || (html += '<a is="emby-linkbutton" href="' + appRouter.getRouteUrl(channel) + '" class="raised raised-mini sectionTitleButton btnMore">' + globalize.translate("sharedcomponents#More") + "</a>"), html += "</div>", html += enableScrollX() ? '<div is="emby-scroller" data-mousewheel="false" data-centerfocus="true"><div class="scrollerframe padded-top-focusscale padded-bottom-focusscale"><div is="emby-itemscontainer" class="scrollSlider focuscontainer-x padded-left padded-right">' : '<div is="emby-itemscontainer" class="itemsContainer padded-left padded-right vertical-wrap focuscontainer-x">', html += cardBuilder.getCardsHtml({
                    ...
                    overlayPlayButton: !0,
                    allowBottomPadding: !enableScrollX()
                }), enableScrollX() && (html += "</div>", html += "</div>"), html += "</div>", html += "</div>"
            }
