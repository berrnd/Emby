...
//myproduction-change-end
    ...
    function fadeInRight(elem) {
        var keyframes, pct, pct = browser.mobile ? "4%" : "0.5%";
        pct = browser.mobile ? "4%" : "0.5%", keyframes = browser.slow ? [{
            opacity: "0",
        ...
        libraryBrowser = {
            ...
            renderName: function(item, nameElem, linkToElement, context) {
                require(["itemHelper"], function(itemHelper) {
                    ...
                    linkToElement ? nameElem.innerHTML = '<a class="detailPageParentLink button-link" is="emby-linkbutton" href="' + appRouter.getRouteUrl(item, {
                        context: context
