    ...
    return function(view, params) {
        ...
        function getTabController(page, index, callback) {
            ...
            require(depends, function(controllerFactory) {
                ...
                controller || (tabContent = view.querySelector(".pageTabContent[data-index='" + index + "']"), controller = 0 === index ? self : 2 === index ? new controllerFactory(view, tabContent, {}) : new controllerFactory(view, params, tabContent), tabControllers[index] = controller, controller.initTab && controller.initTab()), callback(controller)
            })
        }
        ...
        view.querySelector(".btnTakeTour").addEventListener("click", function() {
            ...
            document.querySelector(".skinHeader").classList.add("noHomeButtonHeader"), mainTabsManager.getTabsElement().triggerTabChange(), events.on(playbackManager, "playbackstop", onPlaybackStop), events.on(serverNotifications, "UserDataChanged", onUserDataChanged)
